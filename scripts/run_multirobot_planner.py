...
from swarm_nfomp.warehouse_nfomp.warehouse_nfomp_matplotlib_plotter import (
    WarehouseNfompMatplotlibPlotter,
)
from swarm_nfomp.warehouse_nfomp.warehouse_nfomp_metric_calculator import (
    WarehouseNfompMetricCalculator,
)
from swarm_nfomp.warehouse_nfomp.warehouse_nfomp_visualizer import (
    CollisionDetectionResultVisualizerConfig,
...
def log_figure(logger: clearml.Logger, iteration: int):
    logger.report_matplotlib_figure(
        "warehouse_nfomp_title",
        "warehouse_nfomp_series",
        plt.gcf(),
        report_image=False,
